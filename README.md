...
## Support
For issues or feature requests, please create an issue on our [GitHub repository](https://github.com/amadeco/magento2-sticky-cart).

## License
This module is licensed under the Open Software License 3.0 (OSL-3.0).

## Author
Amadeco - [www.amadeco.fr](https://www.amadeco.fr)